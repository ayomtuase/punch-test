...
const Why = () => {
  return (
    <section className="py-[187px] relative overflow-x-auto  bg-[#F2F4FF]">
      <div className="flex items-center relative px-4 md:px-8 lg:px-[70px]">
        ...
        <div className="flex relative space-x-4 md:space-x-8 space-[70px] mr-4 md:mr-8 lg:mr-[70px]">
          <div className="flex items-center min-w-[1000px] md:min-w-[1300px] rounded-[20px] h-[400px] md:h-[652px] py-[42px] px-10 relative bg-white shadow-[0px_15px_30px_0px_#BFB5FF26]">
          ...
          <div className="flex items-center min-w-[1100px] md:min-w-[1300px] rounded-[20px] h-[400px] md:h-[652px] py-[42px] px-10 relative bg-white shadow-[0px_15px_30px_0px_#BFB5FF26]">
          ...
          <div className="flex items-center min-w-[1100px] md:min-w-[1300px] rounded-[20px] h-[400px] md:h-[652px] py-[42px] px-10 relative bg-white shadow-[0px_15px_30px_0px_#BFB5FF26]">
            ...
            <div className="w-2/5 md:w-1/2 relative h-full shrink-0">
              ...
              <Image
                ...
                height={295}
                alt="Onboard"
                className="absolute top-[298px] left-6"
              />
              <Image
                src="/assets/images/open-book-3.png"
                height={147}
              ...
              <Image
                ...
                height={85}
                alt="Onboard"
                className="absolute top-[596px] left-10"
              />
            </div>
          </div>
        </div>
